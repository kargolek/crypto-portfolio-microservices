 ...
 */
public class EtherscanServiceMockResponse {

    public MockResponse getMockedResStatus200() {
        return new MockResponse()
                .setResponseCode(200)
                .addHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON)
                .setBody(EtherscanResponseResolver.ETHERSCAN_MULTI_WALLET_RES_200_AS_EXPECTED);
    }
    ...
    public MockResponse getMockedResStatus200ResultEmptyArray() {
        return new MockResponse()
                .setResponseCode(200)
                .addHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON)
                .setBody(EtherscanResponseResolver.ETHERSCAN_MULTI_WALLET_RES_200_RESULT_EMPTY_ARRAY);
    }
    ...
    public MockResponse getMockedResStatus200MaxLimitReached() {
        return new MockResponse()
                .setResponseCode(200)
                .addHeader(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON)
                .setBody(EtherscanResponseResolver.ETHERSCAN_RES_200_MAX_LIMIT_REACHED);
    }
